...
The SDK exports these functions and classes. This page covers the instrumentation APIs. Evaluation APIs are documented in [Evaluation & Scoring](/docs/agent-evals/evaluation/).
...
| `evaluate()` | Run agent against dataset with scorers | [Evaluation & Scoring](/docs/agent-evals/evaluation/#evaluate---run-experiments) |
| `Benchmark` | Upload pre-computed eval results | [Evaluation & Scoring](/docs/agent-evals/evaluation/#benchmark---upload-pre-computed-results) |
| `EvalScore` | Scorer return type | [Evaluation & Scoring](/docs/agent-evals/evaluation/#evalscore-dataclass) |
| `BenchmarkResult` | Result from `evaluate()` | [Evaluation & Scoring](/docs/agent-evals/evaluation/#result-types) |
| `BenchmarkSummary` | Aggregate score statistics | [Evaluation & Scoring](/docs/agent-evals/evaluation/#result-types) |
| `TestCaseResult` | Per-case result | [Evaluation & Scoring](/docs/agent-evals/evaluation/#result-types) |
| `ScoreSummary` | Per-metric statistics | [Evaluation & Scoring](/docs/agent-evals/evaluation/#result-types) |
| `OpenSearchTraceRetriever` | Query stored traces from OpenSearch | [Evaluation & Scoring](/docs/agent-evals/evaluation/#opensearchtraceretriever---query-stored-traces) |
...
For running evaluations at scale (`evaluate()`, `Benchmark`, `OpenSearchTraceRetriever`), see [Evaluation & Scoring](/docs/agent-evals/evaluation/).
...
- [Trace Retrieval](/docs/agent-evals/evaluation/#opensearchtraceretriever---query-stored-traces) - query stored traces from OpenSearch
